...
class NetexMapperTest {
  ...
  void sspPointsToUnknownId() {
    ...
    var netexMapper = newNetexMapper(
    ...
    assertThat(issueTypes(issueStore)).contains("ScheduledStopPointAssignedToUnknownQuay");
  }
  ...
  void noticeAssignmentIsNotResolvedAcrossSiblingFiles() {
    ...
    assertThat(issueTypes(issueStore)).contains("NoticeAssignmentWithUnknownEntity");
  }
